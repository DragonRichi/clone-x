...
export const ImageEditor = ({ onClose, previewURL, settings, setSettings }: Props) => {

    const handleChangeSensetive = (sensitive: boolean) => {
        ...
        <div className="fixed w-screen h-screen top-0 left-0 bg-black bg-opacity-75 z-10 flex items-center justify-center">
            <div className="bg-black rounded-xl p-12 flex flex-col gap-4">
                ...
                <div className="w-[600px] h-[600px] flex items-center">
                    <Image src={previewURL} alt="prev" width={600} height={600} className={
                ...
                <div className="flex items-center justify-between text-sm">
                    ...
                    <div
                        ...
                        `}
                        onClick={() => handleChangeSensetive(!settings.sensitive)}
                    >
                        Sensetive
                    </div>
                </div>
